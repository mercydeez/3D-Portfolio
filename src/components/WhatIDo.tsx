        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>LLM &amp; GENAI</h3>
              <h4>Production-Ready AI Systems</h4>
              <p>
                I build and deploy LLM applications, retrieval pipelines, and
                multi-agent workflows that solve real business problems in
          ...
          >
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>BACKEND &amp; CLOUD AI</h3>
              <h4>Scalable APIs and Automation</h4>
              <p>
                I design scalable backend services with FastAPI and Docker,
                integrate AI APIs, and automate business workflows with cloud
